...
function Apple(){
    return(
        <div className='boppers' style={{ display: "flex", flexWrap: "wrap", margin: 15}}>
            <Cardfunc img="https://cdn.discordapp.com/attachments/1024010185968197643/1036186779885252648/20221030_025609.jpg"
            title="result 1"
            color="color1"
            vendor="vendor1"
            shiptime="shiptime1"
            rating="rating1"
            cardlink = "http://api.snowbee.byakuren.pw/info"/>
